...
<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
    <ul class="nav nav-pills nav-stacked" style="border-right:1px solid black">       
        ...
        <li><a href="../addplantedtrees.php"><i class="fa fa-tags"></i> Add Projects </a></li>
        <li><a href="../register.php"><i class="fa fa-tags"></i> Register Admin </a></li>
        <li><a href="../viewplantedtrees.php"><i class="fa fa-tags"></i> View Projects </a></li>
    </ul>
</div>
